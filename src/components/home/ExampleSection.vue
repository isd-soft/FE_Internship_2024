...
<template>
    <section class="section__main section examples-section">
        <div class="examples-section__text">
            ...
            <span class="text-sm examples-section__description">Our designer already made a lot of beautiful prototipe
                of rooms that inspire you</span>
        ...
        <div class="examples-section__container">
            <button class="swiper-button-left examples-section__button-prev">
                <Chevron stroke="#B88E2F"
                    :style="{ transform: 'rotate(180deg)', width: '24px', height: '24px', strokeWidth: '2px' }" />
            </button>
            <swiper class="examples-section__swiper" :slides-per-view="width > 576 ? 2 : 1" :space-between="24"
                :pagination="{
                clickable: true,
            }" :navigation="{ nextEl: '.examples-section__button-next', prevEl: '.examples-section__button-prev' }"
                :keyboard="{ enabled: true }" :modules="[Pagination, Navigation, Keyboard]">
